...
def get_corrections_insert(my_word, word_count_dict):
  ...
  for word1 in edit_one_letter:
    ...
    if word1[0] in word_count_dict and word1 not in suggestions :
      ...
      del_error.append(word_count_dict.get(word1[0]))
...
def get_corrections_switch(my_word, word_count_dict):
  ...
  for word1 in edit_one_letter:
    if word1[0] in word_count_dict:
      ...
      switch_error.append(word_count_dict.get(word1[0]))
...
#   print(edit_one_letter)
  ...
  for word1 in edit_one_letter:
    ...
    if word1[0] in word_count_dict and word1 not in suggestions :
        ...
        replace_error.append(word_count_dict.get(word1[0]))
...
def get_corrections_delete(my_word, word_count_dict):
  ...
  for word1 in edit_one_letter:
    if word1[0] in word_count_dict and word1 not in suggestions :
      ...
      insert_error.append(word_count_dict.get(word1[0]))
...
# frq_error_word=0
# # error_word_frq=int(word.split(' ')[1])
# for i in tmp_corrections:
#   frq_error_word = frq_error_word+int(i[1])
...
#       switch_error_dict[key]=val+frequency*(i[1]/frq_error_word)
#     else: 
#       key = i[2]
#       switch_error_dict[key]=frequency*(i[1]/frq_error_word)

#   elif i[2][0]=='d':
#     if i[2] in delete_error_dict:
#       key=i[2]
#       val=delete_error_dict[key]
#       delete_error_dict[key]=val+frequency*(i[1]/frq_error_word)
#     else: 
#       key = i[2]
#       delete_error_dict[key]=frequency*(i[1]/frq_error_word)

#   elif i[2][0]=='i':
#     if i[2] in insert_error_dict:
#       key=i[2]
#       val=insert_error_dict[key]
#       insert_error_dict[key]=val+frequency*(i[1]/frq_error_word)
#     else: 
#       key = i[2]
#       insert_error_dict[key]=frequency*(i[1]/frq_error_word)

#   elif i[2][0]=='s':
#     if i[2] in replace_error_dict:
#       key=i[2]
#       val=replace_error_dict[key]
#       replace_error_dict[key]=val+frequency*(i[1]/frq_error_word)
#     else: 
#       key = i[2]
#       replace_error_dict[key]=frequency*(i[1]/frq_error_word)
    ...
    for i in tmp_corrections:
      if i[2][0]=='t':
        if i[2] in switch_error_dict:
          key=i[2]
          val=switch_error_dict[key]
          switch_error_dict[key]=val+error_word_frq*(i[1]/suggest_words_frq)
        else: 
          key = i[2]
          switch_error_dict[key]=error_word_frq*(i[1]/suggest_words_frq)

      elif i[2][0]=='d':
        if i[2] in delete_error_dict:
          key=i[2]
          val=delete_error_dict[key]
          delete_error_dict[key]=val+error_word_frq*(i[1]/suggest_words_frq)
        else: 
          key = i[2]
          delete_error_dict[key]=error_word_frq*(i[1]/suggest_words_frq)
      elif i[2][0]=='i':
        if i[2] in insert_error_dict:
          key=i[2]
          val=insert_error_dict[key]
          insert_error_dict[key]=val+error_word_frq*(i[1]/suggest_words_frq)
        else: 
          key = i[2]
          insert_error_dict[key]=error_word_frq*(i[1]/suggest_words_frq)

      elif i[2][0]=='s':
        if i[2] in replace_error_dict:
          key=i[2]
          val=replace_error_dict[key]
          replace_error_dict[key]=val+error_word_frq*(i[1]/suggest_words_frq)
        else: 
          key = i[2]
